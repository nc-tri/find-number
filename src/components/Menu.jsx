  ...
  return (
    <div className="flex text-phudu z-50">
      ...
      >
        <dialog
          open={open}
          className="flex flex-col text-center gap-4 bg-white border border-accent rounded-lg max-w-[280px] w-full mt-[60%] mb-[100%] drop-shadow-lg px-8"
        >
          ...
          <button className="flex text-xl font-semibold rounded-lg text-white overflow-hidden">
            ...
            {true ? (
              <p className="flex-auto p-2 bg-tertiary/90">Bật</p>
            ) : (
              <p className="flex-auto p-2 bg-accent/70">Tắt</p>
            )}
          </button>
          <Link
            to={"/"}
